...
public class MoveState : PlayerState
{
    ...
    /// <summary>
    /// G�re le mouvement horizontal du joueur au sol en appliquant 
    /// une acc�l�ration, une d�c�l�ration et une friction selon les inputs.
    /// </summary>
    ...
    public override void OnUpdate()
    {
        ...
        if (Input.GetKey(KeyCode.L) && Player.blockTimer <= 0)
        {
            Machine.Set<BlockingState>();
        }
        if (Input.GetKeyDown(KeyCode.K) && DashState.dashCurrentCooldown <= 0)
        {
